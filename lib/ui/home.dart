    ...
    return Row(
      ...
      children: <Widget>[
        GestureDetector(
          onTap: () {
            html.window
                .open("https://www.linkedin.com/in/luismayta/", "LinkedIn");
          },
          child: Image.network(
            Assets.linkedin,
            color: Color(0xFF45405B),
        ...
        GestureDetector(
          onTap: () {
            html.window.open("https://medium.com/@luismayta", "Medium");
          },
          child: Image.network(
            Assets.evernote,
            color: Color(0xFF45405B),
        ...
        GestureDetector(
          onTap: () {
            html.window.open("https://github.com/luismayta", "Github");
          },
          child: Image.network(
            Assets.google,
            color: Color(0xFF45405B),
        ...
        GestureDetector(
          onTap: () {
            html.window.open("https://twitter.com/luismayta", "Twitter");
          },
          child: Image.network(
            Assets.twitter,
            color: Color(0xFF45405B),
