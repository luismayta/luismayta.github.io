<!-- Space: ~815773537 -->
<!-- Parent: GithubPage -->
<!-- Title: Contributing GitFlow GithubPage -->
...
To contribute to luismayta.github.io project on [GitHub](https://github.com/luismayta/luismayta.github.io), We use Gitflow (See more [here](https://datasift.github.io/gitflow/IntroducingGitFlow.html)) In a nutshell, it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/luismayta.github.io/pulls).

![workflow gitflow](https://datasift.github.io/gitflow/GitFlowHotfixBranch.png)

## Getting started

To follow the instructions in this guide and start contributing to luismayta.github.io project on Gitlab:
...
```bash
git remote add upstream  https://github.com/luismayta/luismayta.github.io.git
```

Now your **upstream** points to **luismayta/luismayta.github.io**.
...
git fetch upstream # assuming upstream is luismayta/luismayta.github.io
...
All merge requests are automatically tested using [Github Actions](https://github.com/luismayta/luismayta.github.io/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
